...
ALTER TABLE "order_items" ADD CONSTRAINT "order_items_product_id_restaurants_id_fk" FOREIGN KEY ("product_id") REFERENCES "public"."restaurants"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
